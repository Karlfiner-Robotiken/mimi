...
# =========================================================
# MIMI AI — Ultimate Termux AI Agent Installer + Launcher
# Author: Karufen
# Engine: tgpt
# =========================================================
...
mkdir -p ~/.mimi/logs
mkdir -p ~/.mimi/memory
mkdir -p ~/.mimi/plugins

cat > ~/.mimi/mimi.py << 'PYEOF'
import os
import json
import time
import random
...
cat > ~/../usr/bin/mimi << 'EOF'
#!/data/data/com.termux/files/usr/bin/bash
python ~/.mimi/mimi.py
EOF

chmod +x ~/../usr/bin/mimi

echo 'alias mimi="python ~/.mimi/mimi.py"' >> ~/.bashrc
echo 'alias mimi="python ~/.mimi/mimi.py"' >> ~/.zshrc

clear

echo -e "${GREEN}"
echo "======================================="
echo " MIMI AI INSTALLED SUCCESSFULLY"
echo "======================================="
echo -e "${RESET}"

echo -e "${CYAN}Launch using:${RESET}"
echo ""
echo -e "${YELLOW}mimi${RESET}"
echo ""
